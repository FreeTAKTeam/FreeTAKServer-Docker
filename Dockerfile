...
# Supervisord conf
COPY /FTS-Bundle/supervisord.conf /etc/supervisor/conf.d/supervisord.conf
# Logrotation
COPY /FTS-Bundle/ftsrotate /etc/logrotate.d/ftsrotate

COPY /FTS-Bundle/fatalexit /usr/local/bin/fatalexit
